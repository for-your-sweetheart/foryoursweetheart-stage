...
$(window).on('load', function() {
    $(".wpProQuiz_infopage input[type='button']").prop('value', 'Submit');
    $(".wpProQuiz_content .wpProQuiz_button").prop('value', 'Next');
});
...
$(".wpProQuiz_formFields[data-form_id='1'] label").click(function(){
	if($(this).find("input").is(":checked")==true){
		$(".wpProQuiz_formFields[data-form_id='1'] label").removeClass("checked");
		$(this).addClass("checked");
	}else{
		$(this).removeClass("checked");
	}
});
$(".wpProQuiz_formFields[data-form_id='2'] label").click(function(){
	if($(this).find("input").is(":checked")==true){
		$(".wpProQuiz_formFields[data-form_id='2'] label").removeClass("checked");
		$(this).addClass("checked");
	}else{
		$(this).removeClass("checked");
	}
...
jQuery(document).ready(function () {
    $(".wpProQuiz_button").click(function(){
       $(".wpProQuiz_invalidate").html("This field is required.");
    });
	...
	if(myhash == "_jumpsection") {
	    var $targetAnchor = $('#' + myhash +'');
        var headerTopHeightt = $(".header").outerHeight();
	    var targetOffset = $targetAnchor.offset().top-headerTopHeightt-25;
	   setTimeout(function(){$('html, body').animate({scrollTop: $("#_jumpsection").offset().top}, 1000)},1000);
	}
	else if(myhash) {
	    var $targetAnchor = $('#' + myhash +'');
        var headerTopHeightt = $(".header").outerHeight();
	    var targetOffset = $targetAnchor.offset().top-headerTopHeightt-25;
	   setTimeout(function(){$('html, body').animate({scrollTop: targetOffset}, 1000)},1000);
	}
	hash_scroll();
